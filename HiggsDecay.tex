...
\author{Oscar {Castillo-Felisola},\footnote{Corresponding author} Basti\'an {D\'iaz S\'aez},  Felipe {Rojas},  Jilberto {Zamora-Sa\'a} and Alfonso R. {Zerwekh}}
\address{\UTFSM, and \\ \CCTVal.}
\ead{o.castillo.felisola@gmail.com}
...
%%\footnote{%As remarked in Ref.~\cite{Fabbri:2011kq},
...
\end{equation}
We shall use the notation in Refs.~\cite{Castillo-Felisola:2013jva,Castillo-Felisola:2014iia,Castillo-Felisola:2014xba}, where hatted quantities refer to higher dimensional objects and/or indices, and $\ga^{*}$ is the four-dimensional chiral matrix.
